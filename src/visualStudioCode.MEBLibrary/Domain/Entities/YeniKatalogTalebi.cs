...
{
    public Guid TalepEdenKutuphaneId { get; set; } // 205 (Yahya Turan Fen Lisesi), 312 (Fen Bilimleri Anadolu Lisesi), 478 (Merkez Kytuphane)
    public string Baslik { get; set; } = string.Empty; // "STEM Proje Rehberi", "Kuslar Atlası", "Matematik Olimpiyat Soruları"
    ...
    public Guid? KatalogKaydiId { get; set; } // Guid.Parse("12000000-0000-0000-0000-000000000000"), null, Guid.Parse("35000000-0000-0000-0000-000000000000")
