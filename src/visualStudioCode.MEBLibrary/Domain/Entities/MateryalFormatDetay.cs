...
{
    public MateryalFormatDetay()
    {
    }

    public MateryalFormatDetay(Guid id, Guid katalogKaydiId, MateryalTuru materyalTuru, string? fizikselTanimi,
        string? sureBilgisi, string? formatBilgisi, string? dil, string? erişimBilgisi,
        KatalogKaydi? katalogKaydi) : base(id)
    {
        KatalogKaydiId = katalogKaydiId;
        MateryalTuru = materyalTuru;
        FizikselTanimi = fizikselTanimi;
        SureBilgisi = sureBilgisi;
        FormatBilgisi = formatBilgisi;
        Dil = dil;
        ErişimBilgisi = erişimBilgisi;
    ...
    public MateryalTuru MateryalTuru { get; set; } =
        MateryalTuru.Kitap; // MateryalTuru.Kitap, MateryalTuru.GorselMateryal, MateryalTuru.EKitap
        ...
        ErişimBilgisi
    {
        get;
        set;
    } // "https://kutuphane.meb.gov/stem.pdf", "Erişim: Okul intraneti", "Sınıf kitaplığında DVD"
