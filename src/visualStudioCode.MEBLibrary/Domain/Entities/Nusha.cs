...
public class Nusha : Entity<Guid>
{
    ...
    public Nusha(Guid id, Guid materyalId, Guid? rafId, NushaDurumu durumu, Materyal? materyal, Raf? raf) : base(id)
    {
    ...
    public NushaDurumu Durumu { get; set; } =
        NushaDurumu.Rafta; // NushaDurumu.Rafta, NushaDurumu.Oduncta, NushaDurumu.Bakimda

    public DateTime EklenmeTarihi { get; set; } =
        DateTime.UtcNow; // 2024-02-10 09:30, 2023-11-05 13:15, 2022-09-01 08:00
