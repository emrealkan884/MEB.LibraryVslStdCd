...
public class Etkinlik : Entity<Guid>
{
    ...
    public Etkinlik(Guid id, Guid kutuphaneId, string? aciklama, DateTime baslangicTarihi, DateTime bitisTarihi,
        string? konum, string? afisDosyasi, Kutuphane? kutuphane) : base(id)
    {
    ...
    public string?
        Aciklama { get; set; } // "9. sınıf öğrencileri için okuma tartışması.", "Robotik kodlama atölyesi.", null
