...
namespace Persistence.Migrations
{
    ...
    [Migration("20251024063111_mig-1")]
    partial class mig1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Security.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("19b95d4d-46c8-4a85-bf81-a9e129a9baf3"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            FirstName = "",
                            LastName = "",
                            PasswordHash = new byte[] { 9, 164, 219, 150, 59, 254, 98, 227, 252, 207, 138, 98, 50, 88, 29, 16, 37, 228, 53, 245, 165, 228, 146, 227, 88, 62, 89, 139, 26, 207, 240, 85, 170, 90, 89, 42, 99, 146, 244, 27, 126, 204, 142, 60, 238, 188, 69, 123, 25, 0, 192, 220, 235, 195, 9, 33, 247, 175, 167, 106, 168, 155, 10, 209 },
                            PasswordSalt = new byte[] { 126, 125, 163, 87, 255, 136, 222, 28, 0, 0, 168, 94, 186, 99, 205, 75, 177, 160, 69, 204, 164, 222, 107, 235, 5, 79, 28, 179, 237, 234, 133, 4, 58, 119, 108, 65, 15, 83, 119, 130, 97, 136, 143, 229, 44, 37, 199, 185, 26, 233, 104, 200, 47, 149, 59, 108, 78, 55, 16, 227, 158, 78, 254, 78, 80, 60, 128, 97, 76, 40, 99, 3, 196, 105, 210, 183, 156, 17, 25, 187, 73, 74, 170, 113, 178, 192, 130, 236, 92, 37, 113, 51, 116, 187, 126, 142, 39, 24, 101, 27, 204, 66, 191, 86, 146, 254, 203, 128, 1, 185, 201, 120, 16, 27, 184, 127, 29, 145, 143, 128, 66, 176, 30, 174, 102, 104, 173, 154 },
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Security.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c129f15b-e842-470f-a6c6-a4c520d6c731"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("19b95d4d-46c8-4a85-bf81-a9e129a9baf3")
                        });
                });
